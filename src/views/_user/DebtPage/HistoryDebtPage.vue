          ...
          <div class="header-title">
            <b-row>
              ...
              <b-col xl="6" lg="6" md="6" sm="7" class="d-flex justify-content-end custom-export">
                ...
                <button type="button" class="btn btn-sm btn-danger" style="display: inline-block; margin-left: 10px; border: 2px solid white" data-bs-toggle="modal" data-bs-target="#modalDownload" @click="uniqueShipNames">
              ...
              <tbody style="background: white">
                <tr v-for="(item, index) in debts" :key="index++">
                  ...
                  <td style="background: #ff7e3f59">
                    ...
                    <b-button size="sm" variant="primary" style="border-radius: 20px" @click="printPDF()"> <i class="ti ti-printer me-xs-1"></i></b-button>
                  </td>
    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-border" v-if="this.shipDetail">
            <tbody>
              <tr>
...
export default {
  ...
  data() {
    return {
      ...
      debts: [
        {
          id: 1,
          ship_name: "Ship Alpha",
          check_in_at: "2024-09-15",
          check_out_at: "2024-09-20",
          dock_cost: 5000000,
          paid_at: "2024-09-21",
          diff_cost: 1000000,
          diff_paid_at: "2024-09-22"
        },
        {
          id: 2,
          ship_name: "Ship Bravo",
          check_in_at: "2024-09-12",
          check_out_at: null, // Not checked out yet
          dock_cost: 4000000,
          paid_at: null, // Not paid yet
          diff_cost: 500000,
          diff_paid_at: null // No difference paid date
        },
        {
          id: 3,
          ship_name: "Ship Charlie",
          check_in_at: "2024-09-10",
          check_out_at: "2024-09-15",
          dock_cost: 3000000,
          paid_at: "2024-09-16",
          diff_cost: 200000,
          diff_paid_at: "2024-09-17"
        },
        {
          id: 4,
          ship_name: "Ship Delta",
          check_in_at: "2024-09-08",
          check_out_at: "2024-09-13",
          dock_cost: 6000000,
          paid_at: "2024-09-14",
          diff_cost: 1500000,
          diff_paid_at: "2024-09-15"
        },
        {
          id: 5,
          ship_name: "Ship Echo",
          check_in_at: "2024-09-05",
          check_out_at: "2024-09-10",
          dock_cost: 2500000,
          paid_at: null, // Not paid yet
          diff_cost: 0,
          diff_paid_at: null // No difference paid date
  ...
  methods: {
    ...
    async viewPaymentDetail(id) {
      this.shipDetail = this.debts.find((debt) => debt.id === id)
