<template>
  <div class="container-detail">
    ...
    <!-- DETAIL KAPAL  -->
    <div style="position: relative; background: #93c5d063;">
      <div class="row p-5 pb-5" style="position: relative; background: #93c5d063; border-bottom: 3px solid white;">
        <b-col class="col-lg-3 col-md-6">
          <b-card style="box-shadow: 0 4px 10px rgba(83, 83, 83, 0.5); margin-bottom: 10px; margin-top: 10px;">
