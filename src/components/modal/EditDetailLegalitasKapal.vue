<template>
  <div class="modal fade" id="modalEditDetailLegalitasKapal" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none">
    <div class="modal-dialog modal-md modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h4 class="modal-title text-white" style="font-weight: bold">EDIT LEGALITAS KAPAL</h4>
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col mb-4">
                  ...
                  <input type="text" class="form-control" v-model="shipDetail.siup" />
                </div>
              </div>
              <div class="row">
                <div class="col mb-4">
                  <label class="form-label" style="font-weight: bolder">Nomor BKP</label>
                  <input type="text" class="form-control" v-model="shipDetail.bkp" />
                </div>
              </div>
              <div class="row">
                <div class="col mb-4">
    ...
    async updateShipDetail() {
      ...
      try {
        ...
        if (res.status === 200) {
          ...
          $("#modalEditDetailLegalitasKapal").modal("hide")
        }
      } catch (error) {
