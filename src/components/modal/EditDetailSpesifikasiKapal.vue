            ...
            <div class="modal-body">
              <div class="row">
                <div class="col mb-4">
                  ...
                  <select class="form-select" v-model="shipDetail.type">
                    <option :value="shipDetail.type" style="display: none" selected>
                      {{ formatShipStatus(shipDetail.type) }}
                    </option>
              ...
              <div class="row">
                <div class="col mb-4">
                  ...
                  <input type="text" class="form-control" v-model="shipDetail.gt" />
                </div>
              </div>
              <div class="row">
                <div class="col mb-4">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" v-model="shipDetail.width" />
                    <div class="input-group-prepend">
                      <span class="input-group-text">x</span>
                    </div>
                    <input type="text" class="form-control" v-model="shipDetail.length" />
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col mb-4">
                  <label class="form-label" style="font-weight: bolder">Nomor GPS</label>
                  <input type="text" class="form-control" v-model="shipDetail.iot_phone" />
                </div>
              </div>
              <div class="row">
                <div class="col mb-4">
    ...
    async updateShipDetail() {
      ...
      try {
        ...
        if (res.status === 200) {
          ...
          $("#modalEditDetailSpesifikasiKapal").modal("hide")
        }
      } catch (error) {
